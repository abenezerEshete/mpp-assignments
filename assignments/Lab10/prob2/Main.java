...
public class Main {
	public static void main(String[] args) {
		...
		Account a = new Account(127,2000);
	...
	private static < T> boolean containsTarget(Collection <T> mycollection, T i) {
//			if (mycollection==null && i==null) return false;
//
//			return mycollection.stream()
//					.anyMatch(x->x.equals(i));

		if(mycollection == null && i == null) return false;
		for(T x: mycollection) {
